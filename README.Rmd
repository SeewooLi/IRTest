...
**IRTest** is a useful tool for *IRT* (item response theory) parameter *est*imation, especially when the violation of normality assumption on latent distribution is suspected. \
