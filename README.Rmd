...
**IRTest** is a useful tool for `r colorize("IRT", "red")` (item response theory) parameter `r colorize("est", "red")`imation, especially when the violation of normality assumption on latent distribution is suspected. \
