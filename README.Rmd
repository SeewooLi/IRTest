...
**IRTest** is a useful tool for <span style="color: red;">IRT</span> (item response theory) parameter <span style="color: red;">est</span>imation, especially when the violation of normality assumption on latent distribution is suspected. \
