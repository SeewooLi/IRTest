...
#### **IRTest** is a useful tool for \textcolor{red}{IRT} (item response theory) parameter \textcolor{red}{est}imation, especially when the violation of normality assumption on latent distribution is suspected.
