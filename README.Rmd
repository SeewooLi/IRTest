...
**IRTest** can be a useful tool for IRT (item response theory) parameter estimation, especially when

## Installation

You can install the development version of IRTest from [GitHub](https://github.com/) with:
