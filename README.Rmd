...
**IRTest** is a useful tool for _IRT_ (item response theory) parameter _est_imation, especially when the violation of normality assumption on latent distribution is suspected. \
